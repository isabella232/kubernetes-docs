...
cluster is not ready, please follow up the `Setup Instructions <https://kubernetes.io/docs/tutorials/kubernetes-basics/create-cluster/>`__
...
Currently, the `node feature discovery <https://github.com/kubernetes-sigs/node-feature-discovery>`__ provided framwork and reference implement for
...
For instructions on building source code of the `Node feature discovery project <https://github.com/kubernetes-sigs/node-feature-discovery>`__, please
follow up:
...
features, like the 3rd acceleration cards. Please refer to the `open source project <https://github.com/intel/intel-device-plugins-for-kubernetes>`__.
